...
public class CharacterController2D : MonoBehaviour
{
    ...
    public void Jump()
    {
        if (State.IsMovingDownSlope)
            AddForce(new Vector2(0, Parameters.JumpMagnitude * 1.2f));
        else
    ...
    public void LateUpdate()
    {
        ...
        grounded = State.IsCollidingBelow;
    ...
    private void Move(Vector2 deltaMovement)
    {
        ...
        animator.SetFloat("Speed", Mathf.Abs(deltaMovement.x));
    ...
    public void CorrectHorizontalPlacement(ref Vector2 deltaMovement, bool isRight)
    {
    ...
    private void MoveHorizontally(ref Vector2 deltaMovement)
    {
        ...
        {
            var rayVector = new Vector2(rayOrigin.x, rayOrigin.y + (0.05f + (i * _verticalDistanceBetweenRays)));
    ...
    private void HandleVerticalSlope(ref Vector2 deltaMovement)
    {
        ...
        // ReSharper disable CompareOffFloatByEqualityOperator
